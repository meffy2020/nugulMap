...
import { User, Settings, LogOut, MapPin, LogIn } from "lucide-react"
...
export function FloatingUserProfile() {
  ...
  if (isLoading) {
    return <div className="h-12 w-12 rounded-full bg-muted animate-pulse shadow-lg" />
  }
      ...
      <DropdownMenuTrigger asChild>
        ...
        >
          <Avatar className="h-10 w-10">
            <AvatarImage src={getImageUrl(user?.profileImage) || "/neutral-user-avatar.png"} alt={user?.nickname || "사용자"} />
